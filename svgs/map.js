...
$("#map").load("svgs/map.html", function(){
	...
	//redirects
	$('.region1').click(function(){ location.href = "tests.php?title=0&part=0"; });
	$('.region2').click(function(){ location.href = "tests.php?title=1&part=0"; });
	$('.region3').click(function(){ location.href = "tests.php?title=2&part=0"; });
	$('.region4').click(function(){ location.href = "tests.php?title=3&part=0"; });
	$('.region5').click(function(){ location.href = "tests.php?title=4&part=0"; });
});
//redirects