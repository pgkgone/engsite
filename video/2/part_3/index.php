...
<title>Nanotechnology - Part III</title>
...
<div class="header">
    ...
    <div class="task">
        You will watch a video film about the benefits and possible risks of nanotechnology. As you watch, <br>
...
<div class="text">
    <b>14. What energy solutions can nanotechnology provide?</b>
    <ol>
        <li> Creating many different types of nanogenerators. </li>
        <li> Enhancing our ability in renewable energy production. </li>
        <li> Making cell phones more energy efficient. </li>
    </ol>
    <b>15. What do we learn about current cancer therapy?</b>
    <ol>
        <li> All the existing methods of cancer treatment are not very effective. </li>
        <li> It is based on approaches that destroy both cancer and healthy cells. </li>
        <li> There hasn't been made much progress in this field. </li>
    </ol>
    <b>16. What is not TRUE about the problem of water resources?</b>
    <ol>
        <li> People will face the problem of clean water shortage in the near future. </li>
        <li> The traditional technologies are not able to clean salty, dirty and contaminated water efficiently and cost effectively. </li>
        <li> Nanomaterials could be used for filtering dirty water. </li>
    </ol>
    <b>17. What is the major advantage of current nanoengineering?</b>
    <ol>
        <li> Manufacturing innovative satellites. </li>
        <li> Providing new opportunities for space exploration. </li>
        <li> Rebuilding the existing materials to improve their performance. </li>
    </ol>
    <b>18. What is TRUE about silver nanometer according to the film?</b>
    <ol>
        <li> It kills bad microbes. </li>
        <li> It accumulates in the environment and harms it. </li>
        <li> It is widely used in the consumer goods manufacturing. </li>
    </ol>
    <b>19. What do we know about carbon nanotubes for sure?</b>
    <ol>
        <li> Some of them resemble asbestos fibers in shape. </li>
        <li> Their properties are similar to those of asbestos fibers. </li>
        <li> They can cause the same illnesses as asbestos fibers. </li>
    </ol>
    <b>20. What conclusion does Andrew Maynard come to at the end of the film?</b>
    <ol>
        <li> This technology will provide technological solutions of problems and make our society better. </li>
        <li> A careful analysis and evaluation of the potential risks of this technology are necessary. </li>
        <li> The public could help scientists to find risk minimizing solutions. </li>
    </ol>
</div>
